...
const activeLink = computed(() => {
    return props.active ? '#c6eeaa' : '#e2e2e2'
})
</script>

<style scoped>
.notes-svg {
    color: v-bind(activeLink);
}
